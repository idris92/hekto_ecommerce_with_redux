        ...
        <div
				...
				>
					<div className="col-lg-2">
						<img src={picture12 ? `http://127.0.0.1:8000/images/${picture12}`:`http://127.0.0.1:8000/images/${picture11}` } onClick={handlePicture1} style={{ padding: '8px 8px 4px', width:'151px', height:'155px' }} alt="bag1" />
						<img src={picture13 ?`http://127.0.0.1:8000/images/${picture13}`:`http://127.0.0.1:8000/images/${picture11}`} onClick={handlePicture2} style={{ padding: '4px 8px', width:'151px', height:'155px' }} alt="bag2" />
						<img src={picture14 ? `http://127.0.0.1:8000/images/${picture14}`: `http://127.0.0.1:8000/images/${picture11}`} onClick={handlePicture3} style={{ padding: '4px 8px', width:'151px', height:'155px' }} alt="bag3" />
					</div>
					<div className="col-lg-4" style={{width:'375px', height:'487px', overflow:'hidden' }}>
						<img src={`http://127.0.0.1:8000/images/${picture11}`} style={{ padding: '8px 4px',width:'420px', height:'487px',}} alt="bag4" />
					</div>
