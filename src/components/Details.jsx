        ...
        <div
				...
				>
					<div className="col-lg-2">
						<img src={`http://127.0.0.1:8000/images/${picture12}`} onClick={handlePicture1} style={{ padding: '8px 8px 4px', width:'151px', height:'155px' }} alt="bag1" />
						<img src={`http://127.0.0.1:8000/images/${picture13}`} onClick={handlePicture2} style={{ padding: '4px 8px', width:'151px', height:'155px' }} alt="bag2" />
						<img src={`http://127.0.0.1:8000/images/${picture14}`} onClick={handlePicture3} style={{ padding: '4px 8px', width:'151px', height:'155px' }} alt="bag3" />
					</div>
