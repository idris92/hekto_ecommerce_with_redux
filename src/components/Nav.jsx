            ...
            <div className="collapse navbar-collapse " id="navbarSupportedContent">
              <ul className="navbar-nav me-auto mb-2 mb-lg-0 ">
                <li className="nav-item">
                  <a className="nav-link anc top-level" href="#"><i className="far fa-envelope" /> random@gmail.com</a>
                </li>
                <li className="nav-item">
                  <a className="nav-link anc top-level" href="#" style={{marginLeft: '36px'}}><i className="fas fa-phone-alt" /> +234XXXXXXXXX</a>
                </li>
              </ul>
              <ul className="navbar-nav ul1 me-auto mb-2 mb-lg-0">
               ...
               
                {
                  ...
                  <a className="nav-link anc top-level" onClick={handleLogout} style={{textDecoration:'none', color:'#fff', cursor:'pointer'}}>Logout<i className="far fa-user" /></a> 
                 </li>
                  :
                  <li className="nav-item" style={{marginLeft: '15px'}}>
                  <Link className="nav-link anc top-level" to='/login' style={{textDecoration:'none', color:'#fff', cursor:'pointer'}}>Login<i className="far fa-user" /></Link> 
                 </li>
                }
                 {/* <li className="nav-item" style={{marginLeft: '15px'}}>
                ...
                <li className="nav-item" style={{marginLeft: '15px'}}>
                  <a className="nav-link anc top-level" href="#">wishlist <i className="far fa-heart" /></a>
                </li>
                <li className="nav-item cart-container" style={{marginLeft: '15px'}}>
                  <Link className="nav-link anc top-level" to='/cart'><i className="fas fa-shopping-cart" /></Link>
        ...
        <nav className="navbar head2 navbar-expand-lg navbar-light bg-light">
          <div className="container">
            ...
            <div className="collapse navbar-collapse" id="navbarSupportedContent">
              <ul className="navbar-nav me-auto mb-2 mb-lg-0">
                <li className="nav-item">
                  <a className="nav-link anc2 active" aria-current="page" href="/">Home</a>
                </li>
                {/* <li className="nav-item">
                  <a className="nav-link anc2" style={{marginLeft: '35px'}} href="pages.html">pages</a>
                </li> */}
                <li className="nav-item">
                  <a className="nav-link anc2" style={{marginLeft: '35px'}} href="/left">Products</a>
                </li>
                <li className="nav-item">
                  <a className="nav-link anc2" style={{marginLeft: '35px'}} href="#">Blog</a>
                </li>
                <li className="nav-item">
                  <a className="nav-link anc2" style={{marginLeft: '35px'}} href="/grid">Shop</a>
                </li>
                {
                  (localStorage.getItem('jwt') !== null)
                  ?
                  <li className="nav-item">
                  <a className="nav-link anc2" style={{marginLeft: '35px'}} href="/contact">Contact</a>
                </li>
                :''
                }
